document.addEventListener("DOMContentLoaded", () => {
  ...
  // Coba ambil array, fallback ke satuan
  const data = localStorage.getItem("riwayatPesananArray") || localStorage.getItem("riwayatPesanan");
  try {
    const parsed = JSON.parse(data);
    pesananList = Array.isArray(parsed) ? parsed : [parsed];
  } catch {
    pesananList = [];
  }
